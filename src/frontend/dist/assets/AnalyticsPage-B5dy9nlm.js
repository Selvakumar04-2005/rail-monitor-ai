import { aI as commonjsGlobal, aJ as getDefaultExportFromCjs, r as reactExports, aK as clsx, R as React, g as getOccupancyRate, j as jsxRuntimeExports } from "./index-DYLu-g8B.js";
...
function AnalyticsPage({ train }) {
  const coachData = train.coaches.map((c2) => ({
    name: c2.number,
    detected: c2.detected,
    reserved: c2.reserved,
    capacity: c2.capacity,
    rate: getOccupancyRate(c2.detected, c2.capacity)
  }));
  const alertTrend = Array.from({ length: 12 }, (_, i) => ({
    time: `${String(Date.now() - (11 - i) * 3e5).slice(-5)}`,
    label: `-${(11 - i) * 5}m`,
  ...
  const classDistribution = [
    {
      name: "1A",
      value: train.coaches.filter((c2) => c2.class === "1A").reduce((s2, c2) => s2 + c2.detected, 0)
    },
    {
      name: "2A",
      value: train.coaches.filter((c2) => c2.class === "2A").reduce((s2, c2) => s2 + c2.detected, 0)
    },
    {
      name: "3A",
      value: train.coaches.filter((c2) => c2.class === "3A").reduce((s2, c2) => s2 + c2.detected, 0)
    },
    {
      name: "SL",
      value: train.coaches.filter((c2) => c2.class === "SL").reduce((s2, c2) => s2 + c2.detected, 0)
    },
    {
      name: "GEN",
      value: train.coaches.filter((c2) => c2.class === "GEN").reduce((s2, c2) => s2 + c2.detected, 0)
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-lg text-foreground", children: "Analytics" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
        "Real-time journey analytics for Train ",
        train.number
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border bg-card shadow-elevated p-4 space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-sm text-foreground", children: "Occupancy by Coach" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 text-[10px] text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 rounded-sm bg-primary/40" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Reserved" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 rounded-sm bg-primary" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "AI Detected" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border bg-card shadow-elevated p-4 space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-sm text-foreground", children: "Occupancy Rate (%)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 200, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          BarChart,
          {
            data: coachData,
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Tooltip,
                {
                  ...
                  formatter: (v2) => [`${v2}%`, "Occupancy"]
                }
              ),
              coachData.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                Bar,
                {
                  dataKey: "rate",
                  radius: [2, 2, 0, 0],
                  data: [entry],
                  fill: entry.rate >= 110 ? "oklch(0.62 0.22 25)" : entry.rate >= 85 ? "oklch(0.68 0.2 85)" : "oklch(0.65 0.18 145)",
                  name: "Rate"
                },
                entry.name
              )),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "rate", radius: [2, 2, 0, 0], name: "Occupancy %", children: coachData.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                Cell,
                {
                  fill: entry.rate >= 110 ? "oklch(0.62 0.22 25)" : entry.rate >= 85 ? "oklch(0.68 0.2 85)" : "oklch(0.65 0.18 145)"
                },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 text-[10px]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-1 rounded bg-destructive opacity-60" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "100% threshold" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border bg-card shadow-elevated p-4 space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-sm text-foreground", children: "Alert Activity (Last Hour)" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border bg-card shadow-elevated p-4 space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-sm text-foreground", children: "Passenger Class Distribution" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: 160, height: 160, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Pie,
              {
                ...
                paddingAngle: 3,
                dataKey: "value",
                children: classDistribution.map((entry, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: COLORS[i % COLORS.length] }, entry.name))
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { contentStyle: tooltipStyle })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 flex-1", children: classDistribution.map((entry, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono font-semibold text-foreground ml-auto", children: entry.value })
              ]
            },
            entry.name
          )) })
